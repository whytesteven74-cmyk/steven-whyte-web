...
export const NavBar = () => {
    ...
    return (
        <>
            ...
            >
                <nav className="bg-black/60 backdrop-blur-2xl border border-white/10 px-6 py-3 rounded-full shadow-2xl flex items-center gap-8">
                    <Magnetic distance={0.2}>
                        <Link href="/" className="font-mono text-lg font-bold tracking-tighter text-white hover:text-desert-sand transition-colors flex items-center gap-2">
                            <div className="w-8 h-8 rounded-full bg-desert-sand flex items-center justify-center text-black font-bold text-sm">S</div>
                            UNSPOKEN.
                        </Link>
                    </Magnetic>
                ...
                >
                    {links.map((link) => (
                        <Link
                            ...
                            className="text-4xl font-bold font-mono text-gray-400 hover:text-desert-sand uppercase tracking-tighter"
                        >
                            {link.label}
                        </Link>
                    ))}
